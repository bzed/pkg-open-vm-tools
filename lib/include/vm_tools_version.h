 ...
 * appended. Useful until the PRODUCT_VERSION vs. PRODUCT_VERSION_STRING mess
 * in vm_version.h is sorted out.
 */ 
#define TOOLS_VERSION_EXT_CURRENT_CSV   TOOLS_VERSION_CURRENT_CSV,BUILD_NUMBER_NUMERIC
#define TOOLS_VERSION_EXT_CURRENT_STR   TOOLS_VERSION_CURRENT_STR "." BUILD_NUMBER_NUMERIC_STRING
